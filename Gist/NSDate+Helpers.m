...
- (NSString *)stringDaysAgoAgainstMidnight:(BOOL)flag {
    ...
    if (daysAgo == 0) {
        ...
        text = [NSString stringWithFormat:@"%d weeks ago", daysAgo/7];
    } else if (daysAgo < 365) {
        text = [NSString stringWithFormat:@"%d months ago", daysAgo/30];
    } else {
        text = [NSString stringWithFormat:@"%d years ago", daysAgo/365];
    }
	return text;
}
